...
public class DeleteTime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        results.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Activity selectedItem = (Activity) parent.getItemAtPosition(position);

                myRef.child(selectedItem.getUid()).removeValue();

                activityList.remove(selectedItem);
    ...
    public void refresh(String update)
    {
        ...
        {
            if (a.getName().equalsIgnoreCase(update))
            {
                listAdapter.add(a);
            }
        }
